...
![进入主页](https://file.lifeni.life/notebook/存档/hello-boinc/1.webp)

建议在 View 菜单中设置成 Advanced View，这样看起来比较方便。

![高级视图](https://file.lifeni.life/notebook/存档/hello-boinc/2.webp)

### 选择想要贡献的项目

选择工具栏 Tools → Add projects... 添加项目。

![添加项目窗口](https://file.lifeni.life/notebook/存档/hello-boinc/3.webp)
...
![资源占用选项](https://file.lifeni.life/notebook/存档/hello-boinc/4.webp)
