...
![Git Flow](https://file.lifeni.life/notebook/存档/use-git-flow/01.jpg)
...
1. Merge pull request （合并拉请求）
   ...
   ![Merge pull request](https://file.lifeni.life/notebook/存档/use-git-flow/02.jpg)

2. Squash and merge（压缩并合并）

   ![Squash and merge](https://file.lifeni.life/notebook/存档/use-git-flow/03.jpg)
