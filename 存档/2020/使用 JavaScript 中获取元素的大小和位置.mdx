...
![box-sizing 两种写法的对比](https://file.lifeni.life/notebook/存档/js-size-position/01.png)
...
>
> ![引用的图片：三种写法的对比](https://file.lifeni.life/notebook/存档/js-size-position/02.webp)
