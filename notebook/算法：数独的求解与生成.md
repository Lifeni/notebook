...
date: 2020-11-09
description: |
  使用回溯算法完成数独的求解与生成，本文中的算法仅考虑到了数独只有一个解的情况，与这个文章相关的 GitHub 仓库是 [Lifeni/sudoku-solver](https://github.com/Lifeni/sudoku-solver) 和 [Lifeni/sudoku-generator](https://github.com/Lifeni/sudoku-generator) 。
tags:
  - 算法
  - 回溯
